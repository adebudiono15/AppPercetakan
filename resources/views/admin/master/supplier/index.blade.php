                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="width: 300px">
                                                ...
                                                <a href="#" data-id="{{ $item->id }}"
                                                    ...
                                                    <form action="{{ route('hapus-supplier', $item->id) }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="kode_supplier" @error('kode_supplier') class="text-danger" @enderror>KODE SUPPLIER @error('kode_supplier')
                                        | {{ $message }}
                                        @enderror</label>
                                    <input type="text" class="form-control form-control-sm shadow" value="{{ $kode_uniq }}"
                                ...
                                <div class="form-group">
                                    <label for="telepon" @error('telepon') class="text-danger" @enderror>TELEPON @error('telepon')
                                        | {{ $message }}
                                        @enderror</label>
                                    <input type="number" class="form-control form-control-sm shadow" value="{{ old('nama_supplier') }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="nama_supplier" @error('nama_supplier') class="text-danger" @enderror>NAMA @error('nama_supplier')
                                        | {{ $message }}
                                        @enderror</label>
                                    <input type="text" class="form-control form-control-sm shadow" value="{{ old('nama_supplier') }}"
