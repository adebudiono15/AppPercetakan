        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-dark">
                    <h5 class="modal-title text-white">TAMBAH DATA LOGISTIK KELUAR</h5>
                ...
                <form class="form form-vertical" method="post" enctype="multipart/form-data"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-6">
                                     <div class="form-group">
                                    <label for="logistik" @error('logistik') class="text-danger" @enderror>LOGISTIK @error('logistik')
                                        | {{ $message }}
                                        @enderror</label>
                                        <select id="logistikkeluar" name="logistikkeluar" class="js-states form-control" style="width: 100%">
                                            <option value=""></option>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="qty" @error('qty') class="text-danger" @enderror>QTY @error('qty')
                                        | {{ $message }}
                                        @enderror</label>
                                        <input type="number" id="rupiah" class="form-control form-control-sm shadow" name="qty">
                                    </div>
                            </div>
                        </div>
                    </div>
