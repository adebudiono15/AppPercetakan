    <input type="hidden" name="id" value="{{ $logistik->id }}" id="id_data" />
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                <label for="nama" @error('nama') class="text-danger" @enderror>KODE BARANG @error('nama')
                    | {{ $message }}
                    @enderror</label>
                <input type="text" class="form-control form-control-sm shadow" value="{{ $logistik->kode }}" style="height: 28px;" readonly>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group">
                <label for="nama" @error('nama') class="text-danger" @enderror>NAMA @error('nama')
                    | {{ $message }}
                    @enderror</label>
                <input type="text" class="form-control form-control-sm shadow" value="{{ $logistik->nama }}"
            ...
            <div class="form-group">
                <label for="stok" @error('stok') class="text-danger" @enderror>KATEGORI @error('stok')
                    ...
                    <select id="kategori" name="kategori" class="js-states form-control" style="width: 100%">
                        <option value="{{ $logistik->kategori_id }}">{{ $logistik->kategori->nama }}</option>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <label for="stok" @error('stok') class="text-danger" @enderror>STOK @error('stok')
                    | {{ $message }}
                    @enderror</label>
                <input type="text" class="form-control form-control-sm shadow" value="{{ $logistik->stok }}"
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <label for="harga_beli" @error('harga_beli') class="text-danger" @enderror>HARGA BELI @error('harga_beli')
                    | {{ $message }}
                    @enderror</label>
                <input type="text" class="form-control form-control-sm shadow" value="{{ $logistik->harga_beli }}"
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <label for="harga_jual" @error('harga_jual') class="text-danger" @enderror>HARGA JUAL @error('harga_jual')
                    | {{ $message }}
                    @enderror</label>
                <input type="text" class="form-control form-control-sm shadow" value="{{ $logistik->harga_jual }}"
